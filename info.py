...
OWNER_ID = environ.get('OWNER_ID', '6717382350')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002414050120').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002396993826') #Channel / Group Id for force sub ( make sure bot is admin )
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002259872144')) #Log channel id ( make sure bot is admin )
DUMP_CHNL = int(environ.get('DUMP_CHNL', '-1002396682589'))
